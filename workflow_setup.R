...
<head>
    <title>LIFE4138-1-UNUK-AUT-2223: workflowr_setup R script</title>
...
<meta name="keywords" content="moodle, LIFE4138-1-UNUK-AUT-2223: workflowr_setup R script" />
...
M.cfg = {"wwwroot":"https:\/\/moodle.nottingham.ac.uk","sesskey":"Dr74Zd2fKG","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1663777335","slasharguments":1,"theme":"nottingham_mhs","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1663777335","admin":"admin","svgicons":true,"usertimezone":"Europe\/London","contextid":8872116,"langrev":1663777335,"templaterev":"1663777335"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<body  id="page-mod-resource-view" class="format-topics  path-mod path-mod-resource safari dir-ltr lang-en yui-skin-sam yui3-skin-sam moodle-nottingham-ac-uk pagelayout-incourse course-117430 context-8872116 cmid-6231974 category-1427 category-721 category-95 category-208 ">
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" height="250">
  <tr>
    ...
    id="nav-notification-popover-container" data-userid="306265"
    data-region="popover-region">
    <div class="popover-region-toggle nav-link icon-no-margin"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-637f5e6b156b5637f5e6b0a23f2"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-637f5e6b156b5637f5e6b0a23f2"
    ...
    <a id="message-drawer-toggle-637f5e6b28dae637f5e6b0a23f3" class="nav-link d-inline-block popover-region-toggle position-relative icon-no-margin" href="#"
            role="button">
                ...
                <div class="action-menu-trigger">
                    <div class="dropdown">
                        <a href="#" tabindex="0" class="d-inline-block  dropdown-toggle icon-no-margin" id="action-menu-toggle-1" aria-label="User menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-controls="action-menu-1-menu">
                            ...
                            <span class="userbutton"><span class="usertext mr-1">Raziyeh Abdilzadehgharehziaaddin</span><span class="avatars"><span class="avatar current"><img src="https://moodle.nottingham.ac.uk/theme/image.php/nottingham_mhs/core/1663777335/u/f2" class="userpicture defaultuserpic" width="35" height="35" alt="" /></span></span></span>
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/user/profile.php?id=306265" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" tabindex="-1" aria-labelledby="actionmenuaction-2">
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/login/logout.php?sesskey=Dr74Zd2fKG" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" tabindex="-1" aria-labelledby="actionmenuaction-6">
    ...
    <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="https://moodle.nottingham.ac.uk/mod/resource/view.php?id=6231974" aria-current="page" title="File">workflowr_setup R script</a>
                </li>
        </ol>
            ...
            <div id="region-main-box" class="col-12 py-3">
                <section id="region-main" class="has-blocks">
                    <div class="uon-content">
                        ...
                        <div role="main"><span id="maincontent"></span><h2>workflowr_setup R script</h2><div class="resourceworkaround">Click <a href="https://moodle.nottingham.ac.uk/pluginfile.php/8872116/mod_resource/content/1/workflowr_setup.R" onclick="this.target='_blank'">workflowr_setup.R</a> link to view the file.</div></div>
                        <div class="mt-5 mb-1 activity-navigation container-fluid">
<div class="row">
    <div class="col-md-4">        <div class="float-left">
                <a href="https://moodle.nottingham.ac.uk/mod/resource/view.php?id=6231973&forceview=1" id="prev-activity-link" class="btn btn-link" >&#x25C0;&#xFE0E; Reproducibility Workshop 2 slides</a>

        </div>
</div>
    <div class="col-md-4">        <div class="mdl-align">
            <div class="urlselect">
    <form method="post" action="https://moodle.nottingham.ac.uk/course/jumpto.php" class="form-inline" id="url_select_f637f5e6b0a23f12">
        <input type="hidden" name="sesskey" value="Dr74Zd2fKG">
        ...
        <select  id="jump-to-activity" class="custom-select urlselect" name="jump"
                 >
                    ...
                    <option value="/mod/resource/view.php?id=6231968&amp;forceview=1" >Birds R Markdown template</option>
                    ...
                    <option value="/mod/resource/view.php?id=6231973&amp;forceview=1" >Reproducibility Workshop 2 slides</option>
        </select>
            <noscript>
...
coursework) per module.<br></p></div>
  ...
  <span id="sb-4"></span></aside>
    ...
    <div
    id="drawer-637f5e6b2d3a1637f5e6b0a23f13"
    ...
    tabindex="0"
>
            <div id="message-drawer-637f5e6b2d3a1637f5e6b0a23f13" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                ...
                </div>                <div class="hidden h-100" data-region="view-contacts" aria-hidden="true" data-user-id="306265">
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-637f5e6b2d3a1637f5e6b0a23f13"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-637f5e6b2d3a1637f5e6b0a23f13"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-637f5e6b2d3a1637f5e6b0a23f13"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-637f5e6b2d3a1637f5e6b0a23f13"
                                        class="nav-link"
                                        href="#requests-tab-panel-637f5e6b2d3a1637f5e6b0a23f13"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-637f5e6b2d3a1637f5e6b0a23f13"
                                        aria-selected="false"
                                    >
                                        Requests
                                        <span class="badge badge-primary bg-primary ml-2 hidden"
                    ...
                    data-user-id="306265"
                                        id="contacts-tab-panel-637f5e6b2d3a1637f5e6b0a23f13"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-637f5e6b2d3a1637f5e6b0a23f13"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="306265"
                                        id="requests-tab-panel-637f5e6b2d3a1637f5e6b0a23f13"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-637f5e6b2d3a1637f5e6b0a23f13"
                ...
                >
                    <div
                        ...
                        style="overflow-y: auto"
                    ></div>
                </div>                <div class="h-100 view-overview-body" aria-hidden="false" data-region="view-overview"  data-user-id="306265">
                    <div id="message-drawer-view-overview-container-637f5e6b2d3a1637f5e6b0a23f13" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-637f5e6b2d3a1637f5e6b0a23f13"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-637f5e6b2d3a1637f5e6b0a23f13"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="306265"
                                            id="view-overview-favourites-target-637f5e6b2d3a1637f5e6b0a23f13"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-637f5e6b2d3a1637f5e6b0a23f13"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-637f5e6b2d3a1637f5e6b0a23f13"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-637f5e6b2d3a1637f5e6b0a23f13"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="306265"
                                            id="view-overview-group-messages-target-637f5e6b2d3a1637f5e6b0a23f13"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-637f5e6b2d3a1637f5e6b0a23f13"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-637f5e6b2d3a1637f5e6b0a23f13"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="306265"
                                            id="view-overview-messages-target-637f5e6b2d3a1637f5e6b0a23f13"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-637f5e6b2d3a1637f5e6b0a23f13-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-637f5e6b2d3a1637f5e6b0a23f13-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-637f5e6b2d3a1637f5e6b0a23f13-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-637f5e6b2d3a1637f5e6b0a23f13-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-637f5e6b2d3a1637f5e6b0a23f13" >
                                    <label class="custom-control-label" for="enter-to-send-637f5e6b2d3a1637f5e6b0a23f13">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
    ...
    >
        ...
        <div class="menubar d-flex " id="action-menu-3-menubar">
                ...
                <div class="action-menu-trigger">
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/user/profile.php?id=306265" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" tabindex="-1" aria-labelledby="actionmenuaction-8">
                                <i class="icon fa fa-user fa-fw " aria-hidden="true"  ></i>
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/login/logout.php?sesskey=Dr74Zd2fKG" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" tabindex="-1" aria-labelledby="actionmenuaction-12">
                                <i class="icon fa fa-sign-out fa-fw " aria-hidden="true"  ></i>
        ...
        <nav class="list-group" aria-label="">
            <ul>
                    ...
                    <li>
                        <a class="list-group-item list-group-item-action  " href="https://moodle.nottingham.ac.uk/course/view.php?id=49303" data-key="49303" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                            <div class="ml-1">
                                <div class="media">
                                        <span class="media-left">
                                            <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                    <span class="media-body ">Fire Safety (Life Sciences) (UK)</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="list-group-item list-group-item-action  " href="https://moodle.nottingham.ac.uk/course/view.php?id=7616" data-key="7616" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                            <div class="ml-1">
                                <div class="media">
                                        <span class="media-left">
                                            <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                    <span class="media-body ">Safe Use of Microbiological Safety Cabinets (Safety Office) (UK)</span>
                                </div>
                            </div>
                        </a>
                    </li>
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637f5e6b3d1a3637f5e6b0a23f22" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637f5e6b3d1a3637f5e6b0a23f22">
        Library Search (NUSearch)
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637f5e6b3d1a3637f5e6b0a23f22" aria-labelledby="drop-down-637f5e6b3d1a3637f5e6b0a23f22">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637f5e6b3d22f637f5e6b0a23f23" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637f5e6b3d22f637f5e6b0a23f23">
        Library Locations
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637f5e6b3d22f637f5e6b0a23f23" aria-labelledby="drop-down-637f5e6b3d22f637f5e6b0a23f23">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637f5e6b3d2c7637f5e6b0a23f24" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637f5e6b3d2c7637f5e6b0a23f24">
        Studying Effectively
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637f5e6b3d2c7637f5e6b0a23f24" aria-labelledby="drop-down-637f5e6b3d2c7637f5e6b0a23f24">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637f5e6b3d34d637f5e6b0a23f25" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637f5e6b3d34d637f5e6b0a23f25">
        Help
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637f5e6b3d34d637f5e6b0a23f25" aria-labelledby="drop-down-637f5e6b3d34d637f5e6b0a23f25">
...
function(
    ...
    var toggle = $('#message-drawer-toggle-637f5e6b28dae637f5e6b0a23f3');
    Popover.init(toggle);
});
;
        ...
        require(['jquery', 'core/custom_interaction_events'], function($, CustomEvents) {
            ...
            $('#jump-to-activity').on(CustomEvents.events.accessibleChange, function() {
                ...
                $('#url_select_f637f5e6b0a23f12').submit();
            });
        });
    ;

require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-637f5e6b2d3a1637f5e6b0a23f13');
    MessageDrawer.init(root, '637f5e6b2d3a1637f5e6b0a23f13', false);
});
;
...
M.util.js_pending('core/notification'); require(['core/notification'], function(amd) {amd.init(8872116, []); M.util.js_complete('core/notification');});;
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random637f5e6b0a23f26'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random637f5e6b0a23f26'); });
})();
//]]>
</script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"85d36fdef0","applicationID":"3213358","transactionName":"NlJTbBQEWksEAEFYXw8YZEoPSllXAUxHVEMOQkNbA0pCUQAUG0FYEQ==","queueTime":0,"applicationTime":915,"atts":"GhVEGlweSRRHAhcLSxxK","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>